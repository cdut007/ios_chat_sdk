...
open class MessageModule: XmppModule, ContextAware, Initializable {
     ...
     */
    open func sendMessage(in chat:Chat, body:String, type:StanzaType = StanzaType.chat,mechanism:String? = nil,session:String? = nil,uuid:String? = nil, subject:String? = nil, additionalElements:[Element]? = nil) -> Message {
